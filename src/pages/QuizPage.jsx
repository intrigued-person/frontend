...
function QuizPage() {
    ...
    const fetchQuestion = async () => {
        ...
        try {
            const response = await axios.get('http://localhost:8080/city/generate-question');
    ...
    const fetchFunFact = async () => {
        ...
        try {
            const response = await axios.get(`http://localhost:8080/city/fun-fact`, {
                params: {
                    id: questionId
                }
            });
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await axios.post(
                "http://localhost:8080/city/check-answer",
            ...
            if (correct) {
                ...
                const scoreResponse = await axios.post("http://localhost:8080/score", scoreParams, {
                    headers: {
